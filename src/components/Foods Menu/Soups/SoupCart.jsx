...
export default function SoupCart({soupInfo}) {

    const { title, description, price, imageOne, _id } = soupInfo;
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                        <CardContent sx={{ flex: '1 0 auto' }}>
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'row' }}>
                                ...
                                <Link><Button onClick={() => handleDessertItem(soupInfo)} variant="contained" color="success" sx={{ mt: 3, ml: 5 }}>Add to Cart</Button></Link>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                        <CardContent sx={{ flex: '1 0 auto' }}>
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                                ...
                                <Link><Button onClick={() => handleDessertItem(soupInfo)} variant="contained" color="success" sx={{ mt: 3, width: 150 }}>ADD TO CART</Button></Link>
